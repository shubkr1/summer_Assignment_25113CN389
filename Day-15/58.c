...
int main() {
    ...
    // Ask for the number of positions to rotate left
    ...
    // Execute the Reversal Algorithm for Left Rotation
    if (d > 0) {
        reverse(arr, 0, d - 1);     // Step 1: Reverse the first 'd' elements
        reverse(arr, d, size - 1);   // Step 2: Reverse the remaining elements
